...
import { ShieldCheck, Lock, Globe, ArrowUpRight, MapPin, Phone, FileText } from "lucide-react";
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <Link href="/cookie-policy" className="hover:text-lime-400 transition-colors">Cookie Policy</Link>
              </li>
              <li className="flex items-center gap-2">
                <FileText size={14} className="text-gray-500" />
