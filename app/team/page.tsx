...
const teamMembers = [
  {
    ...
    icon: Crown,
    summary:
      "Founder at Finnitrex, guiding strategy, client partnerships, and product direction while collaborating directly with Nneji Chidi Ben on platform architecture and delivery.",
    focus: [
      "Strategic leadership and product direction",
      "Client discovery, scope definition, and partnership development",
      "Cross-functional collaboration during Finnitrex platform development",
    ],
    details: [
      "Crawford University (2020 - 2023)",
      "Certified Web Developer",
      "Well-versed in front-end and back-end development",
      "Exhibits strong leadership and team coordination",
      "Core languages: Python, Java, and C++",
    ],
    spotlight: [
      "Built and supervised multiple web projects, including clothing-store platforms.",
      "Translates business goals into clear technical execution plans.",
      "Supports delivery governance from discovery through launch.",
    ],
