...
const profileCards = [
  {
    ...
    icon: Building2,
    tone:
      "bg-[#dceae6] text-[#16342d] dark:bg-emerald-950/40 dark:text-emerald-100",
  },
  {
  ...
  },
  {
    ...
    icon: Globe,
    tone:
      "bg-[#e4edf6] text-[#1d3145] dark:bg-sky-950/40 dark:text-sky-100",
  },
];
...
export default function AboutPage() {
  return (
    <main className="bg-[#f4f1ec] text-stone-900 transition-colors dark:bg-zinc-950 dark:text-stone-100">
      ...
      <section className="bg-[#efebe6] py-16 dark:bg-zinc-900/70 md:py-24">
        <div className="mx-auto grid max-w-7xl gap-5 px-6 md:px-10 lg:grid-cols-3">
          <article className="flex min-h-[22rem] flex-col justify-between bg-white p-8 shadow-[0_20px_60px_rgba(28,25,23,0.06)] dark:bg-white/5 dark:shadow-none md:col-span-2 md:p-12">
            <div>
          ...
          <article className="flex min-h-[22rem] flex-col justify-center bg-[#08261f] p-8 text-white md:p-12">
            ...
            <p className="mt-5 max-w-xs text-sm leading-7 text-emerald-50/80">
              A London-registered company with a narrative centred on durable
              systems, careful governance, and long-horizon technical value.
            </p>
          </article>
      ...
      <section className="py-20 md:py-28">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 md:px-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:items-start lg:gap-20">
          ...
          <div className="space-y-10">
            ...
            <div className="bg-[#e4ded6] p-8 dark:bg-white/[0.04] md:p-10">
          ...
          <div className="mt-10 grid gap-px overflow-hidden bg-stone-200 dark:bg-white/10 md:grid-cols-2">
            {capabilities.map((capability) => (
              <article
                ...
                className="bg-[#f8f5f0] p-8 dark:bg-zinc-950/80 md:p-10"
              >
