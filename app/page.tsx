    ...
    <main className="relative min-h-screen flex flex-col items-center overflow-x-hidden text-white w-full bg-black">
      ...
      <div className="z-10 container mx-auto px-4 md:px-6 pt-20 pb-20 text-center relative w-full">
        ...
        <div className="mb-8 scale-90 md:scale-100 origin-center inline-block">
          <FinnitrexLogo className="w-48 h-48 md:w-64 md:h-64" /> {/* Bigger as requested */}
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center items-center w-full max-w-md mx-auto md:max-w-none">
           <Link href="/start" className="w-full md:w-auto group relative px-8 py-5 bg-lime-400 text-black font-bold text-lg rounded-none skew-x-[-10deg] hover:skew-x-0 transition-transform duration-300">
      ...
      <div className="z-10 container mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Link href="/fintech" className="group p-8 rounded bg-gray-900/50 border border-gray-800 hover:border-emerald-500 hover:bg-black transition-all">
            ...
            <p className="text-sm text-gray-400 group-hover:text-gray-300">Predictive modeling and fintech visualization.</p>
          </Link>

          <Link href="/robotics" className="group p-8 rounded bg-gray-900/50 border border-gray-800 hover:border-lime-300 hover:bg-black transition-all">
            ...
            <p className="text-sm text-gray-400 group-hover:text-gray-300">Robotics automation research and development.</p>
          </Link>
