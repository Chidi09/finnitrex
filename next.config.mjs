...
const securityHeaders = [
    ...
    },
    {
      ...
      img-src 'self' blob: data: https://www.google.com https://api.microlink.io https://*.microlink.io https://image.thum.io https://*.thum.io https://*.s3.amazonaws.com https://*.s3.us-east-1.amazonaws.com;
      font-src 'self' data:;
      worker-src 'self';
